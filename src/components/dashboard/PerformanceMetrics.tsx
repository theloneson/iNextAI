    ...
    <Card className="glass-card border-primary/20 p-2 md:p-2.5 h-full flex flex-col overflow-hidden">
      ...
      <div className="mb-1.5 md:mb-2">
        ...
        <div className="flex items-baseline gap-1.5">
          <div className="text-base md:text-lg font-bold text-success">+343.6%</div>
      ...
      <div className="grid grid-cols-2 gap-1 md:gap-1.5 mb-1.5 md:mb-2">
        <div className="glass-card p-1 md:p-1.5 rounded-lg border border-primary/10">
      ...
      <div className="flex flex-col items-center justify-center flex-1 min-h-0">
        <svg width={radius * 2} height={radius * 2} className="w-14 h-14 md:w-16 md:h-16">
